...
export default function Carousel() {
    return (
        <div className="flex flex-col">
            <div id="myCarousel" className="carousel slide mb-6 relative " data-bs-ride="carousel">
            ...
            <div className="container marketing mt-6 text-center">
                <div className="row flex flex-wrap mt-4 ml-4 mr-4 box-border max-w-full pr-2 pl-2">
